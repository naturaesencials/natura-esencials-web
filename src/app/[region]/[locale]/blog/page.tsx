          ...
          return (
            <article key={post.slug}>
              <Link href={href} className="group block">
                ...
                <span className="mt-3 inline-block border-b border-ink pb-0.5 text-[11px] uppercase tracking-[0.22em] transition-colors group-hover:border-verde group-hover:text-verde">
                  Leer →
                </span>
              </Link>
            </article>
