...
export default async function BlogPage({ params }: Props) {
  ...
  const labels: Record<string, { title: string; sub: string; readMin: string; desc: string }> = {
    ...
    de: { title: 'Tagebuch', sub: 'Formulierung, Zutaten und Rituale für Naturkosmetik.', readMin: 'Min. Lesezeit', desc: 'Artikel über Formulierung, Zutaten, Wirkstoffe und Rituale für Naturkosmetik. ISO 16128 Zertifizierung, natürliche Inhaltsstoffe und Wirksamkeit ohne Kompromisse.' },
