...
export default async function BlogPage({ params }: Props) {
  ...
  const labels: Record<string, { title: string; sub: string; readMin: string; desc: string }> = {
    es: { title: 'Diario', sub: 'Formulación, ingredientes y rituales de cosmética de origen natural.', readMin: 'min de lectura', desc: 'Artículos sobre formulación, ingredientes activos y rituales de cosmética de origen natural artesanal. ISO 16128, de origen natural y eficacia sin compromisos.' },
    en: { title: 'Journal', sub: 'Formulation, ingredients and cosmetics rituals of natural origin.', readMin: 'min read', desc: 'Articles on formulation, active ingredients and cosmetics rituals of natural origin. ISO 16128 certification, natural origin and efficacy without compromise.' },
    fr: { title: 'Journal', sub: 'Formulation, ingrédients et rituels de cosmétique d\'origine naturelle.', readMin: 'min de lecture', desc: "Articles sur la formulation, les ingrédients actifs et les rituels de cosmétique d'origine naturelle. Certification ISO 16128, origine naturelle et efficacité sans compromis." },
    de: { title: 'Tagebuch', sub: 'Formulierung, Zutaten und Rituale für Naturkosmetik.', readMin: 'Min. Lesezeit', desc: 'Artikel über Formulierung, Zutaten, Wirkstoffe und Rituale für Kosmetik natürlichen Ursprungs. ISO 16128 Zertifizierung, natürlichen Ursprungs Inhaltsstoffe und Wirksamkeit ohne Kompromisse.' },
    it: { title: 'Diario', sub: 'Formulazione, ingredienti e rituali di cosmetica di origine naturale.', readMin: 'min di lettura', desc: 'Articoli su formulazione, ingredienti attivi e rituali di cosmetica di origine naturale. Certificazione ISO 16128, origine naturale ed efficacia senza compromessi.' },
    nl: { title: 'Dagboek', sub: 'Formulering, ingrediënten en rituelen voor Cosmetica van natuurlijke oorsprong.', readMin: 'min lezen', desc: 'Artikelen over formulering, actieve ingrediënten en rituelen voor Cosmetica van natuurlijke oorsprong. ISO 16128 certificering, natuurlijke oorsprong en effectiviteit.' },
    pt: { title: 'Diário', sub: 'Formulação, ingredientes e rituais de cosmética de origem natural.', readMin: 'min de leitura', desc: 'Artigos sobre formulação, ingredientes ativos e rituais de cosmética de origem natural. Certificação ISO 16128, de origem natural e eficácia sem compromissos.' },
  };
