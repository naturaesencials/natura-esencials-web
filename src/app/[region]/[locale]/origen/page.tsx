...
const IMG_ALT: Record<string, string> = {
  es: 'Ingredientes de origen natural en el taller de Natura Esencials, Marbella',
  en: 'of natural origin ingredients at the Natura Esencials workshop, Marbella',
  fr: 'Ingrédients naturels dans l\'atelier Natura Esencials, Marbella',
  de: 'natürlichen Ursprungs Zutaten in der Natura Esencials Werkstatt, Marbella',
  it: 'Ingredienti di origine naturale nel laboratorio Natura Esencials, Marbella',
  nl: 'van natuurlijke oorsprong ingrediënten in het atelier van Natura Esencials, Marbella',
  pt: 'Ingredientes de origem natural na oficina da Natura Esencials, Marbella',
};
...
const C: Record<string, {
  ...
  es: {
    ...
    body0: 'Hecho a mano, con criterio. Natura Esencials nace en Marbella: los productos de cuidado personal y del hogar pueden ser de origen natural, eficaces y fabricados cerca de ti.',
    s1t: 'Quiénes somos',
    s1b: 'Somos un obrador artesanal en el corazón de la Costa del Sol. Desde 2021 formulamos y fabricamos nuestros productos de cosmética de origen natural y limpieza del hogar en nuestro taller de Marbella. Cada lote se elabora manualmente siguiendo fichas técnicas propias y protocolos de calidad exigentes. No somos una marca de distribución: fabricamos lo que vendemos.',
    s2t: 'Cómo fabricamos',
    s2b: 'Nuestros productos se formulan bajo protocolo ISO 16128, el estándar internacional que define el porcentaje real de ingredientes de origen natural. La mayoría de nuestra gama supera el 95 % de naturalidad. Todos nuestros cosméticos son testados dermatológicamente antes de salir al mercado. El proceso va de la materia prima al etiquetado, pasando por la formulación, el control de pH, la estabilidad y el envasado. Sin atajos.',
    ...
    v: [
      {icon:'🌿',label:'ISO 16128',desc:'>95% ingredientes de origen natural'},
  ...
  en: {
    ...
    body0: 'Natura Esencials was born in Marbella — handmade, with purpose: personal care and home products can be of natural origin, effective, and made close to you.',
    s1t: 'Who we are',
    s1b: 'We are an artisanal workshop in the heart of the Costa del Sol. Since 2021 we formulate and manufacture our of natural origin cosmetics and home care products in our Marbella workshop. Each batch is made by hand following our own technical specifications and rigorous quality protocols. We are not a distribution brand — we make what we sell.',
    s2t: 'How we manufacture',
    s2b: 'Our products are formulated under ISO 16128 protocol, the international standard that defines the actual percentage of of natural origin ingredients. Most of our range exceeds 95% natural origin content. All our cosmetics are dermatologically tested before going to market. The process goes from raw material to labelling, through formulation, pH control, stability testing and packaging. No shortcuts.',
    s3t: 'Our ingredients',
    ...
    s4t: 'Our lines',
    s4b: 'We produce three lines: Basic Cosmetics (shampoo, conditioner, hand & body soap, body milk, total body wash), Home Care (detergents, floor cleaner, degreaser, glass cleaner, bathroom cleaner, multi-surface) and Pets (shampoo and hygiene products for dogs and cats). All share the same philosophy: efficacy, natural origin content and safety.',
    s5t: 'Certifications',
    ...
    v: [
      {icon:'🌿',label:'ISO 16128',desc:'>95% of natural origin ingredients'},
  ...
  fr: {
    ...
    s1t: 'Qui sommes-nous',
    s1b: 'Nous sommes un atelier artisanal au cœur de la Costa del Sol. Depuis 2021, nous formulons et fabriquons nos propres produits de cosmétique d\'origine naturelle et d\'entretien ménager dans notre atelier de Marbella. Chaque lot est élaboré à la main, selon nos propres fiches techniques et des protocoles de qualité rigoureux. Nous ne sommes pas une marque de distribution : nous fabriquons ce que nous vendons.',
    s2t: 'Comment nous fabriquons',
    s2b: 'Nos produits sont formulés selon le protocole ISO 16128, la norme internationale qui définit le pourcentage réel d\'ingrédients d\'origine naturelle. La majeure partie de notre gamme dépasse 95 % de naturalité. Tous nos cosmétiques sont testés dermatologiquement avant leur mise sur le marché. Le processus va de la matière première à l\'étiquetage, en passant par la formulation, le contrôle du pH, la stabilité et le conditionnement. Sans raccourcis.',
    s3t: 'Nos ingrédients',
  ...
  de: {
    ...
    body0: 'Natura Esencials wurde in Marbella gegründet — handgemacht, mit Anspruch: Körperpflege- und Haushaltsprodukte können natürlichen Ursprungs, wirksam und in Ihrer Nähe hergestellt werden. Das ist unser Ursprung.',
    s1t: 'Wer wir sind',
    ...
    s2b: 'Unsere Produkte werden nach dem ISO 16128 Protokoll formuliert, dem internationalen Standard für den tatsächlichen Anteil natürlichen Ursprungs Inhaltsstoffe. Der Großteil unserer Produktlinie überschreitet 95 % Natürlichkeit. Alle unsere Kosmetika werden vor der Markteinführung dermatologisch getestet. Der Prozess reicht von der Rohware bis zur Etikettierung, über Formulierung, pH-Kontrolle, Stabilitätsprüfung und Abfüllung. Ohne Abkürzungen.',
    s3t: 'Unsere Zutaten',
    ...
    v: [
      {icon:'🌿',label:'ISO 16128',desc:'>95% natürlichen Ursprungs Inhaltsstoffe'},
  ...
  it: {
    ...
    body0: 'Natura Esencials nasce a Marbella — fatto a mano, con criterio: i prodotti di cura personale e per la casa possono essere di origine naturale, efficaci e prodotti vicino a voi.',
    s1t: 'Chi siamo',
    s1b: 'Siamo un laboratorio artigianale nel cuore della Costa del Sol. Dal 2021 formuliamo e produciamo i nostri prodotti di cosmetica di origine naturale e pulizia della casa nel nostro laboratorio di Marbella. Ogni lotto viene elaborato a mano, seguendo le nostre schede tecniche e protocolli di qualità rigorosi. Non siamo un marchio di distribuzione: fabbrichiamo ciò che vendiamo.',
    s2t: 'Come produciamo',
    s2b: 'I nostri prodotti sono formulati secondo il protocollo ISO 16128, lo standard internazionale che definisce la percentuale reale di ingredienti di origine naturale. La maggior parte della nostra gamma supera il 95% di naturalità. Tutti i nostri cosmetici sono testati dermatologicamente prima di entrare nel mercato. Il processo va dalla materia prima all\'etichettatura, passando per la formulazione, il controllo del pH, la stabilità e il confezionamento. Senza scorciatoie.',
    ...
    v: [
      {icon:'🌿',label:'ISO 16128',desc:'>95% ingredienti di origine naturale'},
  ...
  nl: {
    ...
    v: [
      {icon:'🌿',label:'ISO 16128',desc:'>95% van natuurlijke oorsprong ingrediënten'},
  ...
  pt: {
    ...
    body0: 'A Natura Esencials nasce em Marbella — feito à mão, com critério: os produtos de cuidado pessoal e do lar podem ser de origem natural, eficazes e fabricados perto de si.',
    s1t: 'Quem somos',
    s1b: 'Somos um atelier artesanal no coração da Costa del Sol. Desde 2021 formulamos e fabricamos os nossos próprios produtos de cosmética de origem natural e limpeza do lar no nosso atelier de Marbella. Cada lote é elaborado manualmente, seguindo as nossas próprias fichas técnicas e protocolos de qualidade exigentes. Não somos uma marca de distribuição: fabricamos o que vendemos.',
    s2t: 'Como fabricamos',
    s2b: 'Os nossos produtos são formulados sob o protocolo ISO 16128, a norma internacional que define a percentagem real de ingredientes de origem natural. A maioria da nossa gama supera os 95% de origem natural. Todos os nossos cosméticos são testados dermatologicamente antes de entrar no mercado. O processo vai da matéria-prima à rotulagem, passando pela formulação, controlo do pH, estabilidade e embalagem. Sem atalhos.',
    ...
    s4b: 'Produzimos três linhas: Cosmética básica (champô, condicionador, sabão mãos e corpo, body milk, total body wash), Cuidado do lar (detergentes, limpador de pavimentos, desengordurante, limpa-vidros, limpador de casas de banho, multiusos) e Animais de estimação (champô e produtos de higiene para cães e gatos). Todas partilham a mesma filosofia: eficácia, origem natural e segurança.',
    s5t: 'Certificações',
    s5b: 'Dispomos do certificado ISO 16128 que acredita a origem natural da nossa formulação, do selo Artesanía Hecha en Andalucía e todos os nossos cosméticos são testados dermatologicamente. Estamos registados no Portal de Notificação de Cosméticos da UE (CPNP) em conformidade com o Regulamento (CE) 1223/2009.',
    vTitle: 'Os nossos compromissos',
    v: [
      {icon:'🌿',label:'ISO 16128',desc:'>95% ingredientes de origem natural'},
