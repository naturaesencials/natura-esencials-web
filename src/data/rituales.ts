...
export const rituales: Ritual[] = [
  ...
  // ───── HOGAR ─────
  {
    ...
    subtitles: {
      es: 'Suelos, multisuperficies y cristales: brillo limpio en todo el hogar.',
      en: 'Floor, multi-surface and glass: a clean shine throughout the home.',
      fr: 'Sols, multisurfaces et vitres : un éclat propre dans toute la maison.',
      de: 'Boden, Allzweck und Glas: sauberer Glanz im ganzen Zuhause.',
      it: 'Pavimenti, multisuperfici e vetri: pulizia brillante in tutta la casa.',
      nl: 'Vloer, allesreiniger en glas: een schone glans in huis.',
      pt: 'Chão, multissuperfícies e vidros: um brilho limpo em toda a casa.',
    },
    ingredients: ['limón', 'lima', 'tomillo'],
