...
export const rituales: Ritual[] = [
  ...
  },
  {
    ...
    names: {
      ...
      en: { main: 'Ritual', accent: 'Flawless Kitchen', full: 'Ritual Flawless Kitchen' },
  ...
  },
  {
    ...
    names: {
      ...
      en: { main: 'Ritual', accent: 'Perfect Dishware', full: 'Ritual Perfect Dishware' },
      ...
      nl: { main: 'Ritueel', accent: 'Perfect Servies', full: 'Ritueel Perfect Servies' },
      pt: { main: 'Ritual', accent: 'Louça Perfeita', full: 'Ritual Louça Perfeita' },
    },
    subtitles: {
