...
export function Strip() {
  ...
  return (
    <div className="grid grid-cols-2 gap-x-4 gap-y-5 border-y border-rule bg-paper px-pad-x py-[clamp(28px,4vw,40px)] text-center text-[10px] uppercase tracking-[0.22em] text-graphite lg:grid-cols-3 lg:text-[11px]">
