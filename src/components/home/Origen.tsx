...
export function Origen({ region, locale }: Props) {
  ...
  return (
    <section id="origen-section" className="relative overflow-hidden bg-verde" style={{ minHeight: 'clamp(440px, 72vh, 680px)' }}>
      <Image src="https://images.pexels.com/photos/33168420/pexels-photo-33168420.jpeg?auto=compress&cs=tinysrgb&w=1920" alt="" fill sizes="100vw" className="object-cover" aria-hidden />
